...
/*Dodaj do Profile.fxml je�li b�edy wyskakuj�:
 * 		<?import UserInterface.TextFields.*?>  		
 * to si� chrzani po modyfikacji pliku Profile.fxml*/
...
public class ProfileScreenController {
    ...
    @FXML
    private AgeTextField userAge;
    @FXML
    private HeightTextField userHeight;
    @FXML
    private WeightTextField userWeight;
    @FXML
